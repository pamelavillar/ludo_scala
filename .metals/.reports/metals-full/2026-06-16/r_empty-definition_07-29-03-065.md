error id: file://<HOME>/Downloads/ludo-gui%202/prueba.scala:flatMap.
file://<HOME>/Downloads/ludo-gui%202/prueba.scala
empty definition using pc, found symbol in pc: flatMap.
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -ludo/shared/b/cells/flatMap.
	 -ludo/shared/b/cells/flatMap#
	 -ludo/shared/b/cells/flatMap().
	 -scalafx/scene/layout/b/cells/flatMap.
	 -scalafx/scene/layout/b/cells/flatMap#
	 -scalafx/scene/layout/b/cells/flatMap().
	 -scalafx/Includes.b.cells.flatMap.
	 -scalafx/Includes.b.cells.flatMap#
	 -scalafx/Includes.b.cells.flatMap().
	 -b/cells/flatMap.
	 -b/cells/flatMap#
	 -b/cells/flatMap().
	 -scala/Predef.b.cells.flatMap.
	 -scala/Predef.b.cells.flatMap#
	 -scala/Predef.b.cells.flatMap().
offset: 4605
