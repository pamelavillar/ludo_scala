error id: file://<HOME>/Downloads/ludo-gui%202/prueba.scala:BaseZone#
file://<HOME>/Downloads/ludo-gui%202/prueba.scala
empty definition using pc, found symbol in pc: 
empty definition using semanticdb

found definition using fallback; symbol BaseZone
offset: 1202
...
class BoardView(board: InterfazTablero, onPieceClick: Int => Unit) extends GridPane:
  ...
  private val baseRed    = new BaseZo@@ne(JugadorColor.Red,    piecesOf(JugadorColor.Red,    board), onPieceClick)
